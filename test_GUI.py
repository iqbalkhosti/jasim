...
class TestCatalogAppGUI(unittest.TestCase):
    ...
    def test_apply_filters(self):
        self.app.filter_checkboxes = {
            "Make": [tk.BooleanVar(value=True), tk.BooleanVar(value=False)],
            "Model": [tk.BooleanVar(value=False)]
        }
        self.app.filter_map = {
            "Make": ["Toyota", "Honda"],
            "Model": ["Corolla"]
    ...
    def test_search_with_terms(self):
        ...
        self.app.display_results = MagicMock()
        self.app.search()
        self.app.DB.search.assert_called_with(["Red", "red"])  # match actual behavior
    ...
    def test_display_catalog_with_images(self, mock_urlopen):
        ...
        self.app.display_catalog_grid(test_results)
        mock_urlopen.assert_called_once_with("http://test.com/image.jpg", timeout=ANY)
